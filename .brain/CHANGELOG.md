...
## 2026-08-01 — fix-clarification-quota-dead-end — <pending commit; cross-repo>
...
breaking: no — but PROPOSES a new contract C9 (clarification-quota tier surface), see handoff   affects: Case solve UX, Free-tier rework, Payments/Pricing copy, AI evaluation v2 (prompt file)
