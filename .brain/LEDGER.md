...
| **Casebook** | C | feat/casebook | Core+Toolkit BUILT; Misc BUILT; **Guesstimates section real + promoted to B, new Pain&Promise page (§9.38, in tree), Guesstimate method modules (Pages 2-4) BUILT; P5 cheat sheet + P6 worked solve pending.** | `lib/casebook/*`, `components/casebook/*`, `lib/casebook/content/**` | Casebook-Page-schema |
...
| **Industry Primers** | A | feat/industry-primers | **BUILT (20 primers)** | `public/primers/**`, `app/(app)/learn/industry-primers/**`, `lib/primers/*` | Casebook-tree |
