...
const ABOUT_FAQS = [
  ...
  },
  {
    ...
    answer:
      'Yes — every submission is scored by MECE\'s evaluation engine against a fixed 100-point, six-dimension consulting rubric. The scoring is evidence-based: it rewards applying a framework correctly, not name-dropping one, and each answer comes back with a per-dimension debrief, a short model-answer outline, and any red flags (padding, unsupported claims) called out. An independent arithmetic backstop re-checks the numbers in guesstimates, so the score reflects real reasoning — not guesswork, and not generic chatbot output. The same rubric runs on every submission, which is what makes scores comparable across all of India.',
  },
];
...
const WHAT_YOU_GET = [
  ...
  },
  {
    ...
    body:
      'Submit a case or guesstimate and get a 100-point breakdown — Structure, Quantitative, Synthesis, Business Judgment, Creativity, and Professional Tone — in about 60 seconds. The scoring is evidence-based: every dimension is justified by what you actually wrote, framework-stuffing and unsupported claims are flagged, and you get a short model-answer outline plus an arithmetic backstop that verifies your math.',
  },
  {
    icon: Newspaper,
