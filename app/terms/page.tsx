        ...
        <div className="prose prose-slate max-w-none text-foreground/80 space-y-8">
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              MECE is a technology-driven placement-interview preparation platform with automated rubric evaluation tailored for MBA and PGDM students. The Platform provides case studies, guesstimates, group discussion briefs, and an automated evaluation rubric.
            </p>
            <p className="leading-relaxed">
