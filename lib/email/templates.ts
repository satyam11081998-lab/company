...
// Emails are intentionally IMAGE-FREE: the brand shows as a styled "MECE" wordmark and
// social links are text. Remote images are the single biggest thing that renders broken
// in a spam/preview pane, and a large image-to-text ratio is a strong "promotional bulk"
// signal to inbox filters. A text-forward email can never show a broken image and lands
// in the inbox far more reliably. (Re-introduce a single hosted logo only once inboxing
// is confirmed solid — never image-based social icons.)
  ...
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border:1px solid ${BORDER};border-radius:14px;overflow:hidden;">
      <tr><td style="background:${NAVY};padding:20px 28px;">
        <span style="font-family:Inter,Helvetica,Arial,sans-serif;font-size:22px;font-weight:800;letter-spacing:3px;color:#ffffff;">MECE</span>
      </td></tr>
      ...
      <tr><td style="padding:24px 28px 8px;background:${OFFWHITE};border-top:1px solid ${BORDER};font-family:Inter,Helvetica,Arial,sans-serif;">
        <div style="margin:0 0 2px;font-size:14px;font-weight:700;color:${NAVY};">Team MECE</div>
        ...
        <div style="font-size:13px;color:${MUTED};line-height:1.6;">
          <a href="mailto:team@mece.in" style="color:${MUTED};text-decoration:underline;">Email</a>
          &nbsp;&middot;&nbsp;
          <a href="https://www.linkedin.com/company/mece-prep/" style="color:${MUTED};text-decoration:underline;">LinkedIn</a>
          &nbsp;&middot;&nbsp;
          <a href="https://www.instagram.com/mece.in/" style="color:${MUTED};text-decoration:underline;">Instagram</a>
        </div>
      </td></tr>
